              ...
              <div className="flex flex-col gap-3 mt-5 w-full">
                ...
                <ul className="space-y-2 md:space-y-2 w-auto max-w-[356px]">
                  {[
                    ...
                    <li
                      key={index}
                      className="flex items-start gap-3 text-[#EFEFEF] text-sm md:text-base font-normal pb-2 border-b border-[#FFFFFF]/5 last:border-b-0"
                    >
                      <span className="mt-1">
                        <TickIcon />
                      </span>
  ...
  group-hover:-translate-y-1"
      ...
      <section className="use-cases-section flex flex-col w-full bg-no-repeat bg-bottom bg-cover py-10 md:py-[60px]">
        <div className="max-w-326.5 mx-auto px-4 flex w-full flex-col gap-6 md:gap-12 lg:gap-20">
          ...
          <h3 className="max-w-[523px] w-full justify-start text-slate-50 text-[20px] md:text-[26px] font-bold leading-[32px] md:leading-[42px] text-center md:text-left">
